<div class="item <?php if($itm->history == 'read') { ?> read<?php } ?>" id="item_<?php echo $itm->itm_id; ?>">
	...
	<ul class="item-details">
		...
		<li><a class="from" data-sub_id="<?php echo $itm->sub_id; ?>" href="<?php echo base_url(); ?>home/items/sub/<?php echo $itm->sub_id; ?>"><i class="icon-rss"></i><?php echo $itm->fed_title; ?></a></li>
