<article<?php if($itm->sub->direction) { ?> dir="<?php echo $itm->sub->direction; ?>"<?php } ?> class="item<?php if($itm->history == 'read') { ?> read<?php } ?><?php if($this->input->get('display-items') == 'collapse' || $this->input->cookie('display-items') == 'collapse') { ?> collapse<?php } ?>" id="item_<?php echo $itm->itm_id; ?>">
	<ul class="actions">
		<li><a class="history" href="<?php echo base_url(); ?>home/history/toggle/<?php echo $itm->itm_id; ?>" title="m"><span class="unread"<?php if($itm->history == 'unread') { ?> style="display:none;"<?php } ?>><i class="icon icon-eye-close"></i><?php echo $this->lang->line('keep_unread'); ?></span><span class="read"<?php if($itm->history == 'read') { ?> style="display:none;"<?php } ?>><i class="icon icon-eye-open"></i><?php echo $this->lang->line('mark_as_read'); ?></span></a></li>
		<?php if($this->config->item('star')) { ?>
			<li class="hide-collapse"><a class="star" href="<?php echo base_url(); ?>home/star/<?php echo $itm->itm_id; ?>" title="s"><span class="unstar"<?php if($itm->star == 0) { ?> style="display:none;"<?php } ?>><i class="icon icon-star"></i><?php echo $this->lang->line('unstar'); ?></span><span class="star"<?php if($itm->star == 1) { ?> style="display:none;"<?php } ?>><i class="icon icon-star-empty"></i><?php echo $this->lang->line('star'); ?></span></a></li>
		<?php } ?>
		<?php if($this->config->item('share')) { ?>
			<li class="hide-collapse"><a class="share" href="<?php echo base_url(); ?>home/share/<?php echo $itm->itm_id; ?>" title="<?php echo $this->lang->line('title_shift_s'); ?>"><span class="unshare"<?php if($itm->share == 0) { ?> style="display:none;"<?php } ?>><i class="icon icon-heart"></i><?php echo $this->lang->line('unshare'); ?></span><span class="share"<?php if($itm->share == 1) { ?> style="display:none;"<?php } ?>><i class="icon icon-heart-empty"></i><?php echo $this->lang->line('share'); ?></span></a></li>
		<?php } ?>
		<?php if($this->input->get('display-items') == 'collapse' || $this->input->cookie('display-items') == 'collapse') { ?>
			<li><a class="expand" href="<?php echo base_url(); ?>home/expand/<?php echo $itm->itm_id; ?>" title="<?php echo $this->lang->line('title_o'); ?>"><i class="icon icon-collapse"></i><?php echo $this->lang->line('expand'); ?></a></li>
		...
		<?php } else if($this->input->get('display-items') == 'expand') { ?>
			<li style="display:none;"><a class="expand" href="<?php echo base_url(); ?>home/expand/<?php echo $itm->itm_id; ?>" title="<?php echo $this->lang->line('title_o'); ?>"><i class="icon icon-collapse"></i><?php echo $this->lang->line('expand'); ?></a></li>
	...
	<div class="item-footer hide-collapse">
		...
		<ul class="actions">
			...
			<?php if($this->config->item('share_by_email')) { ?>
				<li class="hide item-share"><a class="modal_show" href="<?php echo base_url(); ?>home/email/<?php echo $itm->itm_id; ?>"><i class="icon icon-envelope"></i><?php echo $this->lang->line('share_email'); ?></a></li>
			<?php } ?>
