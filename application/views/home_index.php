	<nav>
		<ul class="actions">
			...
			<?php if($this->input->cookie('items_display') == 'collapse') { ?>
				<li><a href="#" class="items_display"><span class="expand" title="2" style="display:inline-block;"><i class="icon icon-collapse"></i><span class="button-caption"><?php echo $this->lang->line('expand'); ?></span></span><span class="collapse" title="1" style="display:none;"><i class="icon icon-collapse-top"></i><span class="button-caption"><?php echo $this->lang->line('collapse'); ?></span></span></a></li>
			<?php } else { ?>
			<li><a href="#" class="items_display"><span class="expand" title="2"><i class="icon icon-collapse"></i><span class="button-caption"><?php echo $this->lang->line('expand'); ?></span></span><span class="collapse" title="1"><i class="icon icon-collapse-top"></i><span class="button-caption"><?php echo $this->lang->line('collapse'); ?></span></span></a></li>
			<?php } ?>
			<li class="hide-phone"><a href="<?php echo base_url(); ?>items/read" title="<?php echo $this->lang->line('title_shift_a'); ?>" id="items_read" class="items_read modal_show"><i class="icon icon-ok"></i><span class="button-caption"><?php echo $this->lang->line('mark_all_as_read'); ?>...</span></a></li>
...
<aside>
	<ul>
		...
		<?php } ?>
		<?php if($this->config->item('menu_authors')) { ?>
