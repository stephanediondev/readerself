	<div class="mdl-layout__drawer">
		<nav class="mdl-navigation">
			...
			<li><a id="load-priority-items" class="mdl-navigation__link" href="<?php echo base_url(); ?>items/get/priority" title="<?php echo $this->lang->line('title_g_p'); ?>"><i class="material-icons md-18">chat_bubble</i><?php echo $this->lang->line('priority_items'); ?> (<span>0</span>)</a></li>
