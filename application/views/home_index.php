<div class="mdl-layout__drawer">
	<nav class="mdl-navigation">
		<ul>
			...
			<li><a id="load-cloud-authors-items" class="mdl-navigation__link" href="<?php echo base_url(); ?>items/get/cloud/authors"><i class="material-icons md-18">people</i><?php echo $this->lang->line('authors'); ?></a></li>
			<li><a id="load-cloud-tags-items" class="mdl-navigation__link" href="<?php echo base_url(); ?>items/get/cloud/tags"><i class="material-icons md-18">label</i><?php echo $this->lang->line('tags'); ?></a></li>
			...
			<?php if($this->config->item('folders')) { ?>
				<?php if($folders) { ?>
					<?php foreach($folders as $folder) { ?>
						<li>
							...
							<a class="mdl-navigation__link folder lock" href="<?php echo base_url(); ?>subscriptions/get/folder/<?php echo $folder->flr_id; ?>" title="<?php echo $this->lang->line('open_close'); ?>"><i class="material-icons md-24">keyboard_arrow_up</i></a>
							<ul></ul>
						</li>
					<?php } ?>
				<?php } ?>
				<?php if($count_nofolder > 0) { ?>
					<li>
						...
						<a class="mdl-navigation__link folder lock" href="<?php echo base_url(); ?>subscriptions/get/nofolder" title="<?php echo $this->lang->line('open_close'); ?>"><i class="material-icons md-24">keyboard_arrow_up</i></a>
						<ul></ul>
					</li>
				<?php } ?>
			<?php } ?>
