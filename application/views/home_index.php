...
<aside>
	<ul>
		...
		<?php if($this->config->item('members_list')) { ?>
			<li><a id="load-following-items" class="menu" href="<?php echo base_url(); ?>items/get/following"><i class="icon icon-group"></i><?php echo $this->lang->line('following_items'); ?> (<span>0</span>)</a></li>
		<?php } ?>
