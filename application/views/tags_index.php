<div id="content">
	...
	<div class="actions">
		<ul>
			<li><a href="<?php echo base_url(); ?>tags/add" class="modal_show"><?php echo $this->lang->line('add'); ?></a></li>
		</ul>
	</div>
	...
	<th><a class="modal_show" href="<?php echo base_url(); ?>tags/delete/<?php echo $tag->tag_id; ?>"><?php echo $this->lang->line('delete'); ?></a></th>
	</tr>
	<?php } ?>
	</tbody>
	</table>
